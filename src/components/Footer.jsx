    ...
    <footer className="bg-gray-800 text-white py-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-3">FUTURES Shop</h3>
          ...
          <div>
            ...
            <ul className="text-gray-400">
              <li className="mb-2">Email: contact@futuresshop.com</li>
              <li className="mb-2">Phone: (555) 123-4567</li>
              <li className="mb-2">Address: 123 Main St, New York, NY 10001</li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} FUTURES Team. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
